        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="/admin/services_add" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Services Add</p>
                  </a>
                </li>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped servicess">
              <thead>
                  <tr>
                      <th style="width: 1%">
                          #
              ...
              <tbody>
                @foreach ($services as $services)
                  <tr>
                        ...
                        <td><img src="{{ URL::to('/') }}/images/{{$services->image}}" class="img-thumbnail" width="75"></td> 
                        <td>{{ $services->description }}</td> 
                        <td> 
                        <a href="{{ route('services.edit', [$services->id]) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>  Edit</a>
                            <form class="float-left m-1" action="{{ route('services.destroy', [$services->id]) }}" method="POST"> 
                                @method('delete') 
                                @csrf
