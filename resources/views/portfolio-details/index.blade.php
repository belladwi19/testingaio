...
<head>
  ...
  <title>AIO - Portfolio Details</title>
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="/admin" class="get-started-btn scrollto">Login Admin</a>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              <li><strong>Category</strong>: Product Promotion</li>
              <li><strong>Client</strong>: UMM Company</li>
              <li><strong>Project date</strong>: 21 April, 2021</li>
              <li><strong>Project URL</strong>: <a href="#">www.umm.ac.id</a></li>
            </ul>
          </div>
        ...
        <div class="portfolio-description">
          <h2>Deskripsi Portfolio:</h2>
          <p>
            Buat promosi ribuan produk favorit kamu dengan promo spesial setiap hari.
          </p>
        </div>
