...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="#about" class="get-started-btn scrollto">Login Admin</a>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="assets/img/testimonials/motivate1.png" class="testimonial-img" alt="">
            <h3>Bill Gates</h3>
          ...
          <div class="testimonial-item">
            <img src="assets/img/testimonials/motivate2.png" class="testimonial-img" alt="">
            <h3>Milton Glaser</h3>
            <h4>Designer</h4>
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="assets/img/team/team2.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Bella Dwi M.</h4>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src="assets/img/team/team3.png" class="img-fluid" alt=""></div>
              <div class="member-info">
